...
class ServerQuestionRandomization:
    def server_question_randomization(self):
        self.host = '35.154.36.218'
        self.database = 'qa_testing'
        ...
        self.password = "At@2023$$"
        self.userName = "admin"
        self.inputFile = r"D:\Automation\API_Automation\Input\ServerQuestionRandomization.xls"
        self.outputFile = r"D:\Automation\API_Automation\Output\Server_Que_Random_Check.xls"
        self.htmlInputFile = r"D:\Automation\API_Automation\Output\ServerQuestionRandomization_Check.html"
        self.xlsSheetName = "ServerQuestionRandomization"
        ...
        self.coding_que_ans = (
            ...
            "import java.io.*;\n\npublic class TestClass {\n    public static void main(String[] args) {\n        // Read input from STDIN; write output to STDOUT.\n        a = 90;\n    }\n}",
            "import java.io.*;\n\npublic class TestClass {\n    public static void main(String[] args) {\n        // Read input from STDIN; write output to STDOUT.\n        a = 100;\n    }\n}")
        self.coding_que_lang = (25331, 25334, 25333, 25332, 25335, 25336)
        ...
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        excel_read_obj.excel_read(self.inputFile, 0)
        self.xls_values = excel_read_obj.details
        wb_result = xlwt.Workbook()
        self.ws = wb_result.add_sheet(self.xlsSheetName, cell_overwrite_ok=True)
        col_index = 0
        self.file = open(self.htmlInputFile, "wt")
    ...
    def loginToTest(self, loginId, password):
        ...
        print("loginToTest Token - ", self.Test_Login_TokenVal)
    ...
    def loadTest(self):
        ...
        loadtest_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM,
                           "X-AUTH-TOKEN": self.Test_Login_TokenVal}
        loadtest_data = {
    ...
    def get_test_result(self):
        get_testresult_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM,
                                 "X-AUTH-TOKEN": self.Test_Login_TokenVal}
        get_testresult_data = {}
    ...
    def testResultCollection(self):
        ...
        for k, v in self.questionid_vs_questiontype.items():
            if v == "MCQ":
                ...
                # candidate_lang_choice.append(self.coding_que_lang_value[candidate_ans_lang])
                # print("actual lang : ", self.coding_que_lang_value[candidate_ans_lang])
    ...
    def submit_test_result(self):
        ...
        #  Partial submit test
        # ----------------------------------------------------------------------------------------------------------
        submit_test_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM,
                              "X-AUTH-TOKEN": self.Test_Login_TokenVal}
        submit_test_data = {"isPartialSubmission": True, "totalTimeSpent": 39,
                            "testResultCollection": self.candidate_testResultCollection,
                            "config": "{\"TimeStamp\":\"2024-01-17T07:28:55.933Z\"}"}

        submit_request = requests.post("https://amsin.hirepro.in/py/assessment/htmltest/api/v1/submitTestResult/",
                                       headers=submit_test_header, data=json.dumps(submit_test_data, default=str),
                                       verify=True)
    ...
    def loginToAMS(self):
        ...
        data0 = {"LoginName": self.loginName, "Password": self.password, "TenantAlias": self.tenantAlias,
    ...
    def reActivate_candidate(self, candidateId, testId):
        ...
        # ----------------------------------------------------------------------------------------------------------
        eval_online_assessment_header = {"content-type": "application/json", "APP-NAME": self.appName,
                                         "X-APPLMA": self.appLAM, "X-AUTH-TOKEN": self.NTokenVal}
