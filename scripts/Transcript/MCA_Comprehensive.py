...
class McaComprehensive:
    def __init__(self):
        ...
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCA_Comprehensive.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCA_Comprehensive.html"
    ...
    def mca_comprehensive(self):
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCA Deep Dive - Comprehensive Report</h1>
                </div>
                </head>
    ...
    def reportData(self):
        ...
        mcaQuestions = transcript_response['data']['multipleCorrectAnswer']
        ...
        for indx in groupSectionInfo:
            for indxx in indx.get('sectionInfo'):
                if indxx.get('questionType') == "MultipleCorrectAnswer":
        ...
        for data in mcaQuestions:
            ...
            q_data.append(data.get('jsonCorrectAnswerStr'))
...
if __name__ == "__main__":
    trans = McaComprehensive()
    trans.mca_comprehensive()
    trans.login()
    trans.reportData()
    trans.logout()