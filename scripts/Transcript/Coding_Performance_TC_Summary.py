...
class CodingPerformanceTcSummary:
    ...
    def __init__(self):
        ...
        self.inputFilePath = r"D:\Automation\API_Automation\Input\Coding_Performance_TCSummary.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\\Coding_Performance_TCSummary.html"
    ...
    def coding_performance_tc_summary(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    trans.coding_performance_tc_summary()
    trans.login()
    trans.report_data()