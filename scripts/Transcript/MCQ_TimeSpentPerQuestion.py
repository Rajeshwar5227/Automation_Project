...
class McqTimeSpentPerQuestion:
    def __init__(self):
        ...
        # self.inputFilePath = input_dir / 'MCQ_Candidate_Performance_TSPQ.xls'
        # self.outputFilePath = output_dir / 'MCQ_Candidate_Performance_TSPQ.html'
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCQ_Candidate_Performance_TSPQ.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCQ_Candidate_Performance_TSPQ.html"
    ...
    def mcq_time_spent_per_question(self):
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCQ Deep Dive - Candidate Performance By Time Spent Per Question</h1>
                </div>
                </head>
        ...
        for login_details in self.xls_values:
            ...
            # for k, v in login_details:
            #     inputIds.append(login_details['Q1_Id'])
            ...
            self.Q13_Id = int(login_details.get('Q13_Id'))
            self.Q13_DL = str(login_details.get('Q13_DL'))
            self.Q13_TS = int(login_details.get('Q13_TS'))
            self.Q13_Status = str(login_details.get('Q13_Status'))
            self.Q14_Id = int(login_details.get('Q14_Id'))
            self.Q14_DL = str(login_details.get('Q14_DL'))
            self.Q14_TS = int(login_details.get('Q14_TS'))
            self.Q14_Status = str(login_details.get('Q14_Status'))
            ...
            self.expected_data_dict = {self.Q1_Id: [self.Q1_DL, self.Q1_TS, self.Q1_Status],
                                       ...
                                       self.Q13_Id: [self.Q13_DL, self.Q13_TS, self.Q13_Status],
                                       self.Q14_Id: [self.Q14_DL, self.Q14_TS, self.Q14_Status]}
            self.file.write("""<tr>
                            <td></td>
                            <td></td>
                            ...
                            <td>""" + str(self.Q13_Id) + """</td><td>""" + str(self.Q13_DL) + """</td>
                            <td>""" + str(self.Q13_TS) + """</td><td>""" + str(self.Q13_Status) + """</td>
                            <td>""" + str(self.Q14_Id) + """</td><td>""" + str(self.Q14_DL) + """</td>
                            <td>""" + str(self.Q14_TS) + """</td><td>""" + str(self.Q14_Status) + """</td>
                            """)
    ...
    def login(self):
        ...
        login_data = {"LoginName": self.loginId, "Password": self.password, "TenantAlias": self.tenantAlias,
    ...
    def reportData(self):
        ...
        for i in range(len(transcript_response['data']['mcq'])):
            question_ids.append(transcript_response['data']['mcq'][i]['id'])
            qid = transcript_response['data']['mcq'][i]['id']
            candidateAnswer = transcript_response['data']['mcq'][i]['candidateAnswer']
            obtainedMark = transcript_response['data']['mcq'][i]['obtainedMark']
            timeSpent = transcript_response['data']['mcq'][i]['timeSpent']
            difficultyLevel = transcript_response['data']['mcq'][i]['difficultyLevel']
        ...
        for j in range(len(transcript_response['data']['referenceToContext'])):
            question_ids.append(transcript_response['data']['referenceToContext'][j]['id'])
            qid = transcript_response['data']['referenceToContext'][j]['id']
            candidateAnswer = transcript_response['data']['referenceToContext'][j]['candidateAnswer']
            obtainedMark = transcript_response['data']['referenceToContext'][j]['obtainedMark']
            timeSpent = transcript_response['data']['referenceToContext'][j]['timeSpent']
            difficultyLevel = transcript_response['data']['referenceToContext'][j]['difficultyLevel']
            if difficultyLevel == 1:
                difficultyLevel = 'Low'
            elif difficultyLevel == 4:
                difficultyLevel = 'Medium'
