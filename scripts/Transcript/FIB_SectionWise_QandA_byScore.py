...
class FibSectionWiseQandAByScore:
    def __init__(self):
        self.overall_Statua = []
        ...
        self.inputFilePath = r"D:\Automation\API_Automation\Input\FIB_SectionWise_QA_byScore.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\FIB_SectionWise_QA_byScore.html"
        # self.inputFilePath = "D:\Automation\API_Automation\Input\FIB_SectionWise_QA_byScore.xls"
        # self.outputFilePath = "D:\Automation\API_Automation\Output\FIB_SectionWise_QA_byScore.html"
    ...
    def fib_section_wise_q_and_a_by_score(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>FIB Deep Dive - Candidate Performance SectionWise_QandA_byScore</h1>
                </div>
                </head>
        ...
        for elem in self.grpVsSec:
            for elemm in groupAndSectionWiseMarks:
                if elem == elemm['name']:
                    ...
                    if elemm['obtainedMarks'] is None:
...
if __name__ == "__main__":
    trans = FibSectionWiseQandAByScore()
    trans.fib_section_wise_q_and_a_by_score()
    trans.login()
    trans.reportData()
    trans.logout()