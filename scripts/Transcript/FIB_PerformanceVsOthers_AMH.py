import datetime, xlwt, json, requests
from constants import api
from common.read_excel import *
from pathlib import Path


class FibPerformanceVsOthersAmh:
    def __init__(self):
        self.overall_Status = []
        ...
        self.inputFilePath = r'D:\Automation\API_Automation\Input\FIB_Candidate_Performance_AMH.xls'
        self.outputFilePath = r'D:\Automation\API_Automation\Output\FIB_Candidate_Performance_AMH.html'
        # self.inputFilePath = "D:\Automation\API_Automation\Input\FIB_Candidate_Performance_AMH.xls"
        # self.outputFilePath = "D:\Automation\API_Automation\Output\FIB_Candidate_Performance_AMH.html"
    ...
    def fib_performance_vs_others_amh(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>FIB Deep Dive - Candidate Performance vs others</h1>
                </div>
                </head>
...
if __name__ == "__main__":
    trans = FibPerformanceVsOthersAmh()
    trans.fib_performance_vs_others_amh()
    trans.loginToTest()
    trans.reportData()