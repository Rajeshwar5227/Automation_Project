...
class McaSectionWiseQandAByCount:
    def __init__(self):
        self.overall_Status = []
        ...
        self.inputFilePath = r'D:\Automation\API_Automation\Input\MCA_SectionWise_QA_byCount.xls'
        self.outputFilePath = r'D:\Automation\API_Automation\Output\MCA_SectionWise_QA_byCount.html'
        ...
        # self.inputFilePath = input_dir / 'MCA_SectionWise_QA_byCount.xls'
        # self.outputFilePath = output_dir / 'MCA_SectionWise_QA_byCount.html'
        # self.inputFilePath = "D:\Automation\API_Automation\Input\MCA_SectionWise_QA_byCount.xls"
        # self.outputFilePath = "D:\Automation\API_Automation\Output\MCA_SectionWise_QA_byCount.html"
    ...
    def mca_section_wise_q_and_a_by_count(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    trans = McaSectionWiseQandAByCount()
    trans.mca_section_wise_q_and_a_by_count()
    trans.login()
    trans.reportData()
    trans.logout()
