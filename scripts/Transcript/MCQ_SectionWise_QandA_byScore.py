...
class McqSectionWiseQandAByScore:
    def __init__(self):
        self.overall_Status = []
        ...
        # self.inputFilePath = input_dir / 'MCQ_SectionWise_QA_byScore.xls'
        # self.outputFilePath = output_dir / 'MCQ_SectionWise_QA_byScore.html'
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCQ_SectionWise_QA_byScore.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCQ_SectionWise_QA_byScore.html"
    ...
    def mcq_section_wise_q_and_a_by_score(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCQ Deep Dive - Candidate Performance SectionWise_QandA_byScore</h1>
                </div>
                </head>
