...
class FibSectionWiseQandAByCount:
    def __init__(self):
        self.overall_Status = []
        ...
        self.inputFilePath = r"D:\Automation\API_Automation\Input\FIB_SectionWise_QA_byCount.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\FIB_SectionWise_QA_byCount.html"
        # self.inputFilePath = "D:\Automation\API_Automation\Input\FIB_SectionWise_QA_byCount.xls"
        # self.outputFilePath = "D:\Automation\API_Automation\Output\FIB_SectionWise_QA_byCount.html"
    ...
    def fib_section_wise_q_and_a_by_count(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>FIB Deep Dive - Candidate Performance SectionWise_QandA_byQuestionCount</h1>
                </div>
                </head>
...
if __name__ == "__main__":
    trans = FibSectionWiseQandAByCount()
    trans.fib_section_wise_q_and_a_by_count()
    trans.login()
    trans.reportData()
    trans.logout()