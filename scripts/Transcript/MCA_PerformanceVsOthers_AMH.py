...
class McaPerformanceVsOthersAmh:
    def __init__(self):
        self.overall_Statua = []
        ...
        # self.inputFilePath = input_dir / 'MCA_Candidate_Performance_AMH.xls'
        # self.outputFilePath = output_dir / 'MCA_Candidate_Performance_AMH.html'
        self.inputFilePath = r'D:\Automation\API_Automation\Input\MCA_Candidate_Performance_AMH.xls'
        self.outputFilePath = r'D:\Automation\API_Automation\Output\MCA_Candidate_Performance_AMH.html'

        # self.inputFilePath = "D:\Automation\API_Automation\Input\MCA_Candidate_Performance_AMH.xls"
        # self.outputFilePath = "D:\Automation\API_Automation\Output\MCA_Candidate_Performance_AMH.html"
    ...
    def mca_performance_vs_others_amh(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCA Deep Dive - Candidate Performance vs others</h1>
                </div>
                </head>
