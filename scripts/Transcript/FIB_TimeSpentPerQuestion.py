...
class FibTimeSpentPerQuestion:
    def __init__(self):
        ...
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCA_Candidate_Performance_TSPQ.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCA_Candidate_Performance_TSPQ.html"
        # self.inputFilePath = "D:\Automation\API_Automation\Input\MCA_Candidate_Performance_TSPQ.xls"
        # self.outputFilePath = "D:\Automation\API_Automation\Output\MCA_Candidate_Performance_TSPQ.html"
    ...
    def fib_time_spent_per_question(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCA Deep Dive - Candidate Performance By Time Spent Per Question</h1>
                </div>
                </head>
    ...
    def reportData(self):
        ...
        for i in range(len(transcript_response['data']['multipleCorrectAnswer'])):
            question_ids.append(transcript_response['data']['multipleCorrectAnswer'][i]['id'])
            qid = transcript_response['data']['multipleCorrectAnswer'][i]['id']
            candidateAnswer = transcript_response['data']['multipleCorrectAnswer'][i]['candidateAnswer']
            obtainedMark = transcript_response['data']['multipleCorrectAnswer'][i]['obtainedMark']
            timeSpent = transcript_response['data']['multipleCorrectAnswer'][i]['timeSpent']
            difficultyLevel = transcript_response['data']['multipleCorrectAnswer'][i]['difficultyLevel']
...
if __name__ == "__main__":
    trans = FibTimeSpentPerQuestion()
    trans.fib_time_spent_per_question()
    trans.login()
    trans.reportData()
    trans.logout()