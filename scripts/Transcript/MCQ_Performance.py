...
class McqPerformance:
    def __init__(self):
        ...
        # self.inputFilePath = input_dir / 'MCQ_Performance_Transcript.xls'
        # self.outputFilePath = output_dir / 'MCQ_Performance_Transcript.html'
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCQ_Performance_Transcript.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCQ_Performance_Transcript.html"
    ...
    def mcq_performance(self):
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>Transcript - MCQ Performance Report</h1>
                </div>
                </head>
        ...
        for login_details in self.xls_values:
            ...
            # self.Total_Marks = [self.Q1_Total_Marks, self.Q2_Total_Marks, self.Q3_Total_Marks, self.Q4_Total_Marks, self.Q5_Total_Marks]
            # self.Obt_Marks = [self.Q1_Marks, self.Q2_Marks, self.Q3_Marks, self.Q4_Marks, self.Q5_Marks]
            ...
            self.loginToTest()
            self.reportData()
        self.file.write("""</tbody></table></div></div></body><div class="div-overalldata"><span class="label">Execution Date:&nbsp;&nbsp;</span><span class="lable value">""" + str(
    ...
    def reportData(self):
        ...
        CandidateRank = transcript_response['data']['questionTypeWiseOverall']['mcq']['rank']
        RankOutOf = transcript_response['data']['assessment']['testUsersWithScore']
        marksObtained = transcript_response['data']['questionTypeWiseOverall']['mcq']['marks']
        marksOutOf = transcript_response['data']['questionTypeWiseOverall']['mcq']['totalMarks']
        percentage = transcript_response['data']['questionTypeWiseOverall']['mcq']['percentage']
        averageScore = transcript_response['data']['questionTypeWiseOverall']['mcq']['averageMarks']
        highestScore = transcript_response['data']['questionTypeWiseOverall']['mcq']['highestMarks']
        ...
        g3_totalMarks = transcript_response['data']['groupAndSectionWiseMarks'][4]['totalMarks']
        g3_obtainedMarks = transcript_response['data']['groupAndSectionWiseMarks'][4]['obtainedMarks']
        g4_totalMarks = transcript_response['data']['groupAndSectionWiseMarks'][5]['totalMarks']
        g4_obtainedMarks = transcript_response['data']['groupAndSectionWiseMarks'][5]['obtainedMarks']
