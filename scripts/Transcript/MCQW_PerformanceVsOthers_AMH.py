...
class McqwPerformanceVsOthersAmh:
    def __init__(self):
        self.overall_Status = []
        ...
        # self.inputFilePath = input_dir / 'MCQW_Candidate_Performance_AMH.xls'
        # self.outputFilePath = output_dir / 'MCQW_Candidate_Performance_AMH.html'
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCQW_Candidate_Performance_AMH.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCQW_Candidate_Performance_AMH.html"
    ...
    def mcqw_performance_vs_others_amh(self):
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCQW Deep Dive - Candidate Performance vs others</h1>
                </div>
                </head>
