...
class McqSectionWiseQandAByCount:
    def __init__(self):
        self.overall_Status = []
        ...
        # self.inputFilePath = input_dir / 'MCQ_SectionWise_QA_byCount.xls'
        # self.outputFilePath = output_dir / 'MCQ_SectionWise_QA_byCount.html'
        self.inputFilePath = r"D:\Automation\API_Automation\Input\MCQ_SectionWise_QA_byCount.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\MCQ_SectionWise_QA_byCount.html"
    ...
    def mcq_section_wise_q_and_a_by_count(self):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.file.write("""<html>
                ...
                <div class="div-h2">
                    <h1>MCQ Deep Dive - Candidate Performance SectionWise_QandA_byQuestionCount</h1>
                </div>
                </head>
