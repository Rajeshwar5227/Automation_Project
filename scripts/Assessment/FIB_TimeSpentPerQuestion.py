...
class FibTimeSpentPerQuestion(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCA_Candidate_Performance_TSPQ']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCA_Candidate_Performance_TSPQ']
    ...
    def fib_time_spent_per_question(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
