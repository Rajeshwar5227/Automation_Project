...
class SubjectivePerformance(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['Subjective_Performance']
        self.outputFilePath = outputFile.OUTPUT_PATH['Subjective_Performance']
    ...
    def subjective_performance(self, server):
