...
class McaComprehensive(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCA_Comprehensive']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCA_Comprehensive']
    ...
    def mca_comprehensive(self, server):
