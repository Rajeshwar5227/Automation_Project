...
class McqDifficultyLevel(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Statua = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQ_Candidate_Performance_DL']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQ_Candidate_Performance_DL']
    ...
    def mcq_difficulty_level(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
