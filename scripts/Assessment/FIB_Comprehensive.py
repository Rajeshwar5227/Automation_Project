...
class FibComprehensive(login.CommonLogin):
    ...
    def __init__(self):
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['FIB_Comprehensive']
        self.outputFilePath = outputFile.OUTPUT_PATH['FIB_Comprehensive']
    ...
    def fib_comprehensive(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
