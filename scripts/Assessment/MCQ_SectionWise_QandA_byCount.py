...
class McqSectionWiseQandAByCount(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQ_SectionWise_QA_byCount']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQ_SectionWise_QA_byCount']
    ...
    def mcq_section_wise_q_and_a_by_count(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
