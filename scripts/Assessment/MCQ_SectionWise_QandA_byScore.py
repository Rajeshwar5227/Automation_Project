...
class McqSectionWiseQandAByScore(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQ_SectionWise_QA_byScore']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQ_SectionWise_QA_byScore']
    ...
    def mcq_section_wise_q_and_a_by_score(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
