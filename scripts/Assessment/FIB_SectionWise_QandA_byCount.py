...
class FibSectionWiseQandAByCount(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['FIB_SectionWise_QA_byCount']
        self.outputFilePath = outputFile.OUTPUT_PATH['FIB_SectionWise_QA_byCount']
    ...
    def fib_section_wise_q_and_a_by_count(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
