...
class McqwSectionWiseQandAByScore(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "py3app"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQW_SectionWise_QA_byScore']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQW_SectionWise_QA_byScore']
    ...
    def mcqw_section_wise_q_and_a_by_score(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
