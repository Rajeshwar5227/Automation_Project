...
class McqwTimeSpentPerQuestion(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "py3app"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQW_Candidate_Performance_TSPQ']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQW_Candidate_Performance_TSPQ']
    ...
    def mcqw_time_spent_per_question(self, server):
