...
class FibDifficultyLevel(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['FIB_Candidate_Performance_DL']
        self.outputFilePath = outputFile.OUTPUT_PATH['FIB_Candidate_Performance_DL']
    ...
    def fib_difficulty_level(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
