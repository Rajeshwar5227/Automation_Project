...
class FibSectionWiseQandAByScore(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Statua = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['FIB_SectionWise_QA_byScore']
        self.outputFilePath = outputFile.OUTPUT_PATH['FIB_SectionWise_QA_byScore']
    ...
    def fib_section_wise_q_and_a_by_score(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
