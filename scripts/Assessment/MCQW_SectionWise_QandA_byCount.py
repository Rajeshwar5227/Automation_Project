...
class McqwSectionWiseQandAByCount(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "py3app"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQW_SectionWise_QA_byCount']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQW_SectionWise_QA_byCount']
    ...
    def mcqw_section_wise_q_and_a_by_count(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
