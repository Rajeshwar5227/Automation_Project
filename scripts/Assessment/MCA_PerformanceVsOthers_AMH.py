...
class McaPerformanceVsOthersAmh(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Statua = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCA_Candidate_Performance_AMH']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCA_Candidate_Performance_AMH']
    ...
    def mca_performance_vs_others_amh(self,server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
