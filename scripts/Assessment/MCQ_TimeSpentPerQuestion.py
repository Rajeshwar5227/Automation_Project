...
class McqTimeSpentPerQuestion(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQ_Candidate_Performance_TSPQ']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQ_Candidate_Performance_TSPQ']
    ...
    def mcq_time_spent_per_question(self, server):
