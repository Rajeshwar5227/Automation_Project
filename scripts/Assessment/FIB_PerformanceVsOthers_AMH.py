...
class FibPerformanceVsOthersAmh(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['FIB_Candidate_Performance_AMH']
        self.outputFilePath = outputFile.OUTPUT_PATH['FIB_Candidate_Performance_AMH']
    ...
    def fib_performance_vs_others_amh(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
