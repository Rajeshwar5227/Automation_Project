...
class McqPerformance(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "crpo"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQ_Performance_Transcript']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQ_Performance_Transcript']
    ...
    def mcq_performance(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
