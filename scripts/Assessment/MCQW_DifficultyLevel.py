...
class McqwDifficultyLevel(login.CommonLogin):
    def __init__(self):
        super().__init__()
        self.overall_Status = []
        ...
        self.appName = "py3app"
        self.isLambda = "true"
        self.inputFilePath = inputFile.assessment['MCQW_Candidate_Performance_DL']
        self.outputFilePath = outputFile.OUTPUT_PATH['MCQW_Candidate_Performance_DL']
    ...
    def mcqw_difficulty_level(self, server):
        # --------------------------------------------------------------------------------------------------------------
        # Read from Excel
        # --------------------------------------------------------------------------------------------------------------
