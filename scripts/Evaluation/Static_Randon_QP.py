...
class StaticRandomQpEvaluation:
    def __init__(self):
        print()
    def static_random_qp_evaluation(self):
        ...
        self.inputFilePath = r"D:\Automation\API_Automation\Input\staticrandomQP_Evaluation.xls"
        self.outputFilePath = r"D:\Automation\API_Automation\Output\staticrandomQP_Evaluation.xls"
        # "X-APPLMA": "true", "APP-NAME": "py3app"
        self.host = '35.154.36.218'
        self.database = 'appserver_core'
        self.db_user = 'hireprouser'
        self.db_pwd = 'tech@123'
        self.appLAM = "true"
        self.appName = "crpo"
        # --------------------------------------------------------------------------------------------------------------
        ...
        wb = xlrd.open_workbook(self.inputFilePath)
        wb_result = xlwt.Workbook()
        ws = wb_result.add_sheet('randomQP_Evaluation', cell_overwrite_ok=True)
        ...
        while n < sh1.nrows:
            ...
            # ----------------------------------------------------------------------------------------------------------
            login_to_test_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM}
            ...
            loadtest_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM, "X-AUTH-TOKEN": self.Test_Login_TokenVal}
            data2 = {}
            ...
            submit_test_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM, "X-AUTH-TOKEN": self.Test_Login_TokenVal}
            ...
            crpo_login_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM}
            data0 = {"LoginName": "admin", "Password": "4LWS-0671", "TenantAlias": "automation",
                     "UserName": "admin"}
            ...
            eval_online_assessment_header = {"content-type": "application/json", "X-AUTH-TOKEN": self.NTokenVal,
                                             "APP-NAME": self.appName, "X-APPLMA": self.appLAM}
            ...
            # ----------------------------------------------------------------------------------------------------------
            view_candidate_score_by_candidate_id_header = {"content-type": "application/json", "APP-NAME": self.appName, "X-APPLMA": self.appLAM,
            ...
            print(json.loads(view_candidate_score_by_candidate_id_request.content))
            ...
            ws.write(rownum, 78, Expected_Test_Total)
            ScoreData = json.loads(view_candidate_score_by_candidate_id_request.content)['data']['groupAndSectionWiseMarks']
            ...
            #     if json.loads(view_candidate_score_by_candidate_id_request.content)['data']['testUserScore'][ite]['candidateId'] == candidateId:
            k = 0
            while k <= 12:
                if json.loads(view_candidate_score_by_candidate_id_request.content)['data']['groupAndSectionWiseMarks'][0]['id'] == 13040:
                    Actual_Group1_Score = json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][0]['obtainedMarks']
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data']['groupAndSectionWiseMarks'][0]['sectionInfo'][k]["sectionId"] == 47164:
                    Actual_Section1_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data']['groupAndSectionWiseMarks'][0]['sectionInfo'][k]['obtainedMarks']
                    if (round(section_and_expectedmarks[47164], 3) == Actual_Section1_Score):
                        ...
                        Section_1_Id = json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][0]['sectionInfo'][k]["sectionId"]
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data']['groupAndSectionWiseMarks'][0]['sectionInfo'][k]["sectionId"] == 47165:
                    Actual_Section2_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data']['groupAndSectionWiseMarks'][
                            0]['sectionInfo'][k]['obtainedMarks']
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][0]['sectionInfo'][k]["sectionId"] == 47166:
                    Actual_Section3_Score = json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][1]['id'] == 13041:
                    Actual_Group2_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][
                            1]['obtainedMarks']
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][1]['sectionInfo'][k]["sectionId"] == 47167:
                    Actual_Section4_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][
                            1]['sectionInfo'][k]['obtainedMarks']
                    if (round(section_and_expectedmarks[47167], 3) == Actual_Section4_Score):
                        ...
                        Section_4_Id = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][1]['sectionInfo'][k]["sectionId"]
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][1]['sectionInfo'][k]["sectionId"] == 47168:
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][2]['id'] == 13042:
                    Actual_Group3_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][
                            2]['obtainedMarks']
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][2]['sectionInfo'][k]["sectionId"] == 47169:
                    Actual_Section7_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][
                            2]['sectionInfo'][k]['obtainedMarks']
                    if (round(section_and_expectedmarks[47169], 3) == Actual_Section7_Score):
                        ws.write(rownum, 63, Actual_Section7_Score, self.__style3)
                    else:
                        ws.write(rownum, 63, Actual_Section7_Score, self.__style2)
                        Section_7_Id = json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][2]['sectionInfo'][k]["sectionId"]
            ...
            k = 0
            while k <= 12:
                if json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][2]['sectionInfo'][k]["sectionId"] == 47170:
                    Actual_Section6_Score = json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][2]['sectionInfo'][k]['obtainedMarks']
                    if (round(section_and_expectedmarks[47170], 3) == Actual_Section6_Score):
                        ws.write(rownum, 65, Actual_Section6_Score, self.__style3)
                    else:
                        ws.write(rownum, 65, Actual_Section6_Score, self.__style2)
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['id'] == 13043:
                    Actual_Group4_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['obtainedMarks']
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['sectionInfo'][k]["sectionId"] == 47171:
                    Actual_Section9_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['sectionInfo'][k]['obtainedMarks']
                    if (round(section_and_expectedmarks[47171], 3) == Actual_Section9_Score):
                        ws.write(rownum, 67, Actual_Section9_Score, self.__style3)
                    else:
                        ws.write(rownum, 67, Actual_Section9_Score, self.__style2)
                        Section_9_Id = json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['sectionInfo'][k]["sectionId"]
            ...
            while k <= 12:
                if \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['sectionInfo'][k]["sectionId"] == 47172:
                    Actual_Section8_Score = \
                        json.loads(view_candidate_score_by_candidate_id_request.content)['data'][
                            'groupAndSectionWiseMarks'][3]['sectionInfo'][k]['obtainedMarks']
                    if (round(section_and_expectedmarks[47172], 3) == Actual_Section8_Score):
                        ws.write(rownum, 69, Actual_Section8_Score, self.__style3)
                    else:
                        ws.write(rownum, 69, Actual_Section8_Score, self.__style2)
            ...
            wb_result.save(self.outputFilePath)
            n += 1
            rownum += 1
