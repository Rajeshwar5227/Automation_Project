...
class CodingQpEvaluation:
    ...
    def __init__(self):
        ...
        self.appName = "crpo"
        self.crpo_tkn = ""
        self.input_path = r"D:\Automation\API_Automation\Input\CodingNew.xls"
        self.output_path = r"D:\Automation\API_Automation\Output\CodingNew.xls"
    ...
    def evaluate(self):
        ...
        eval_assessment_payload = {"testId": 22019}
    ...
    def fetch_actual(self):
        ...
        for item in self.actual_data:
            question_ids = [item["Q1_Id"], item["Q2_Id"]]
